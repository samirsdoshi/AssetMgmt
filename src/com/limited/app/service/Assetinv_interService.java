...
@Service
public class Assetinv_interService extends BaseService{
	...
	public List<AssetinvInter> getByAssetinvID(int value){
		getAssetinvInterExample().clear();
		AssetinvInterExample.Criteria c=getAssetinvInterExample().createCriteria();
